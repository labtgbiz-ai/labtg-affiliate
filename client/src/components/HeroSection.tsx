      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center min-h-[calc(100vh-80px)] py-12">
          ...
          <div className="flex flex-col gap-6 lg:gap-8">
            ...
            {/* Headline */}
            <div>
              <h1 className="font-['Raleway'] font-black text-4xl md:text-5xl lg:text-6xl text-gray-900 leading-[1.1] tracking-tight" style={{paddingTop: '3px', paddingBottom: '20px', paddingLeft: '2px'}}>
                Зарабатывайте{' '}
