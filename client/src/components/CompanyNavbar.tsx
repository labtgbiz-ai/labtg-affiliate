/* LabTG Company Landing — Navbar
   Design: Glassmorphism, sticky, brand blue CTA, smooth scroll, active tracking, i18n
*/
...
export default function CompanyNavbar() {
  ...
  const navLinks = [
    ...
    { href: '#ai-agent', label: t('nav.aiAgent'), id: 'ai-agent' },
    { href: '#team', label: t('nav.team'), id: 'team' },
    { href: '#contact', label: t('nav.contacts'), id: 'contact' },
  ];
  ...
  useEffect(() => {
    const sectionIds = ['about', 'services', 'ai-agent', 'team', 'contact'];
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          >
            ...
            <div className="hidden sm:block">
              ...
              <span className="block text-[10px] text-gray-400 font-medium leading-none -mt-0.5">{t('hero.badge')}</span>
            </div>
          </a>
          ...
          <nav className="hidden lg:flex items-center gap-1">
            {navLinks.map((link) => (
              <a
                ...
                className={`text-sm font-medium px-3 py-2 rounded-full transition-all duration-200 whitespace-nowrap ${
