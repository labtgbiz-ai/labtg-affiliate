        ...
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-['Raleway'] font-900 text-xl tracking-tight">LabTG</span>
            </div>
            ...
            <div className="flex items-center gap-1.5 mt-3">
              ...
              <span className="text-gray-400 text-xs">Принимаем партнёров</span>
            </div>
          </div>

          {/* Navigation */}
          <div>
            <h4 className="font-['Raleway'] font-bold text-sm text-gray-300 mb-4 uppercase tracking-wider">
              Навигация
            </h4>
