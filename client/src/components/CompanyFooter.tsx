/* LabTG Company Landing — Footer
   Design: Dark footer with company info, links and partner program
*/
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div>
                <span className="font-['Raleway'] font-black text-lg text-white tracking-tight">LabTG</span>
              </div>
            </div>
            ...
            <a
              href="/partners"
              className="inline-flex items-center gap-2 text-sm font-semibold text-[#1E9BF0] hover:text-blue-300 transition-colors group"
            >
          ...
          {/* Services */}
          <div>
            <h4 className="font-bold text-white mb-4 text-sm uppercase tracking-wider">Услуги</h4>
            ...
            <ul className="space-y-2.5 text-sm text-gray-400">
              <li>
                <a href="https://t.me/labtg_manager" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#1E9BF0]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a href="mailto:info@labtg.ru" className="hover:text-white transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#1E9BF0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <li>
                <a href="tel:+79999999999" className="hover:text-white transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#1E9BF0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
